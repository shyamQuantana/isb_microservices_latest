...
let Constants = {
    ...
    // this are questions before starting course
    LESSON_PRE_ASSESSMENT_SCORE: 1,
    // this are leeson short answer questions
    LESSON_SHORT_ANSWER_ZERO_SCORE: 0,
    //questions answered middle of the course
    LESSON_KNOWLEDGE_CHECK_ACCURACY_SCORE: 1,
    //questions answered middle of the course attempting
    LESSON_KNOWLEDGE_CHECK_ATTEMPTING_SCORE: 1,
    // questions answered in the module level
    MODULE_ASSESSMENT_ACCURACY_SCORE: 2,
    // questions answered in the module level attempting
    MODULE_ASSESSMENT_ATTEMPTING_SCORE: 1,
    // score for finishing the module before the module end date
    MODULE_COMPLETION_BONUS_SCORE: 10,
    // questions answered at finishing  of the course
    FINAL_COURSE_ASSESSMENT_ACCURACY_SCORE: 3,
    // attempting the question at final course level
    FINAL_COURSE_ASSESSMENT_ATTEMPTING_SCORE: 1,
    // course entity type
    COURSE_ACTIVITY_ENTITY_TYPE: 1,
    // module entity type
    MODULE_ACTIVITY_ENTITY_TYPE: 2,
    // lesson entity type
    LESSON_ACTIVITY_ENTITY_TYPE: 3,
    // social learning attendance from gather score
    SOCIAL_LEARNING_ATTENDANCE_SCORE: 10,
    // social learning attempting subjective q&a in lesson score
    SOCIAL_LEARNING_ATTEMPTING_SUBJECTIVE_QA_LESSON_SCORE: 0,
    ...
    CHECK_ALL_THAT_APPLY: "oli_check_all_that_apply",

    MULTI_INPUT: "oli_multi_input",

    MULTIPLE_CHOICE: "oli_multiple_choice",

    SHORT_ANSWER: "oli_short_answer",

    CUSTOM_DND: "oli_custom_dnd",

    ORDERING: "oli_ordering",

    SOCIAL_LEARNING_ACTIVITY: "social_learning_activity",
    ...
    NOTIF_TYPE_EMAIL:0,
    NOTIF_TYPE_SMS:1,
    NOTIF_TYPE_PUSH_NOTIFICATION:2,
    NOTIF_TYPE_ISBX_PUSH_NOTIFICATION:3,
    NOTIF_TYPE_PM_NOTIFICATION:4,
    NOTIF_COURSE_START_REMINDER: 1,
    NOTIF_MODULE_END_REMINDER: 2,
    NOTIF_MODULE_START_REMINDER: 3,
    NOTIF_COURSE_PAYMENT_REMINDER: 4,
    NOTIF_COURSE_PAYMENT_CONFIRMATION: 5,
    NOTIF_COURSE_END_REMINDER: 6,
    NOTIF_COURSE_COMPLETION_CONFIRMATION: 7,
    NOTIF_COURSE_CERTIFICATE_AWARDED: 8,
    NOTIF_COURSE_CERTIFICATE_NOT_ISSUED: 9,
    NOTIF_SLA_ROLE_EMAIL: 10,
    NOTIF_PROGRAM_START_EMAIL: 11,
    NOTIF_PROGRAM_LATE_JOINERS_EMAIL: 12,
    WEEKLY_PLAN_NOTIFICATION: 13,
    NOTIF_PROGRAM_SLA_EMAIL: 14,
    NOTIF_COURSE_PAYMENT_USER_ENROLLMENT: 15,
    NOTIF_SFDC_ENROLLMENT_EMAIL: 16,
    NOTIF_RESET_PASSWORD_EMAIL: 17,
    NOTIF_FREE_LESSON_USER: 18,
    NOTIF_PROGRAM_APPLICATION_SUBMISSION:19,
    NOTIF_PROGRAM_APPLICATION_STATUS_UPDATE:20,
    NOTIF_GENERIC_EMAIL: 21,
    NOTIF_ISBX_PROGRAM_END_REMINDER: 22,
    NOTIF_ISBX_COURSE_END_REMINDER: 23,
    NOTIF_ISBX_TEACHER_RANK_INFO_NOTIFICATION: 24,
    NOTIFICATION_VIEWED: 1,
    NOTIFINCATION_NOT_VIEWED: 0,
    NOTIFICATION_NOT_SENT:0,
    NOTIFICATION_SENT:1,
    NOTIF_TEMPORARY_REVOKE_ACCESS_EMAIL:22,
    NOTIF_PERMENANT_REVOKE_ACCESS_EMAIL:23,
    NOTIF_PAYMENT_DATE_EXTENDING_EMAIL:24,

    NOTIF_TEMPORARY_REVOKE_ACCESS_EMAIL:22,
    NOTIF_PERMENANT_REVOKE_ACCESS_EMAIL:23,
    NOTIF_PAYMENT_DATE_EXTENDING_EMAIL:24,

    SLA_NOTIFICATION_BY_ROLE: "Role",
    SLA_NOTIFICATION_BY_GROUP: "Group",
    SLA_NOTIFICATION_BY_ALL: "All",
    SLA_ROLE_UNASSIGNED: "Unassigned",

    SCHEDULE_EMAIL_TYPE_GENERIC : 0,
    SCHEDULE_EMAIL_TYPE_SLA : 1,
    SCHEDULE_EMAIL_SEND_NOW: 0,
    SCHEDULE_EMAIL_SCHEDULE_SEND: 1,
    ...
    NOTIF_MODULE_PUSH_START_REMINDER: 4,
    NOTIF_MODULE_PUSH_END_REMINDER: 5,
    NOTIF_COURSE_PUSH_START_REMINDER: 6,
    NOTIF_COURSE_PUSH_ASSESSMENT_DUE_REMINDER: 7,
    NOTIF_COURSE_PUSH_ASSESSMENT_COMPLETE_REMINDER: 8,
    NOTIF_MODULE_PUSH_BONUS_REMINDER: 9,
    NOTIF_MODULE_PUSH_BADGE_COMPLETED_REMINDER: 10,
    NOTIF_MODULE_PUSH_GET_BADGE_REMINDER: 11,
    NOTIF_LESSON_POINTS_PUSH_NOTIFICATION: 12,
    NOTIF_ISBX_LESSON_POINTS_PUSH_NOTIFICATION: 30,
    NOTIF_ACTIVITY_REEVALUATION_NOTIFICATION: 13,
    NOTIF_ACTIVITY_REEVALUATION_PM_NOTIFICATION: 14,
    NOTIF_EARNED_BONUS_POINTS_NOTIFICATION: 15,
    NOTIF_MODULE_COMPLETED_NOTIFICATION: 28,
    NOTIF_ISBO_MODULE_COMPLETED_NOTIFICATION: 29,
